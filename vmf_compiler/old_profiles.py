...
class ConfigProfilesWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.modes.append_page(
            table_window, self.notebook_tab('Edit', Gtk.STOCK_EXECUTE)
        )
        self.modes.append_page(
            self.mode.raw, self.notebook_tab('Raw', Gtk.STOCK_FILE)
        )
        ...
        col_command = Gtk.TreeViewColumn(
            "Command", cell_command, text=1
        )
